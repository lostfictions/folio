  ...
  render() {
    return (
      <div>
        ...
        <p>
          Browser tech is pretty amazing to me. It’s easy to forget that what
          use to read Facebook or check email doubles as a synthesizer, a 3D
          renderer, a MIDI interface – and offers lots of other rich affordances
          besides. I’ve been thinking a lot about how lots of folks are carrying
          this kit of creative tools in their pockets, and how it would just
          take a bit of plumbing to make them much more accessible. Since there
          are many future directions this project could take me, it’s at times
          been helpful for me to think of it in this way while prototyping – as
          just a bit of plumbing to make low-hanging affordances a little bit
          easier to reach.
        </p>
        <p>
